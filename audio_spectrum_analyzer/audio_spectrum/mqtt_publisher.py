...
class MqttPublisher:
    ...
    def publish_discovery(self, stream: StreamIdentity) -> None:
        ...
        for freq in TARGET_FREQUENCIES_HZ:
            ...
            payload = {
                ...
                "value_template": "{{ value_json['%s']['db'] }}" % freq,
                "json_attributes_topic": state_topic,
                "json_attributes_template": "{{ value_json['%s'] | tojson }}" % freq,
    ...
    def publish_state(self, stream: StreamIdentity, spectrum_by_hz: dict[str, dict[str, float]]) -> None:
